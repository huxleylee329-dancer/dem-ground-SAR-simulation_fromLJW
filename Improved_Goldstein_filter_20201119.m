...
function [phase_filter] = Improved_Goldstein_filter_20201119(Original_Interferogram,Win_size,coherence)
%% 空间自适应滤波
%窗参数
...
for ii = Radius+1:Ni-Radius
  for jj = Radius+1:Nj-Radius
      ...
      [window_mean,window(ii,jj)] = Mean_Filter_Correlation_20201119(phase_estimation,Gamma+0.2,PSD_Window,Win_size);
...
%       residual_noise_phase(ii-Radius:ii+Radius,jj-Radius:jj+Radius) = phase_0_matrix;
     ...
     %%残留相位滤波
      ...
      phase_0 = Improved_Goldstein_Correlation_20201119(phase_0_matrix,D); 
